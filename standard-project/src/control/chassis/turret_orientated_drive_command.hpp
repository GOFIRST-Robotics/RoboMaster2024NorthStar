 ...
 */
class ChassisTurretDriveCommand : public tap::control::Command
{
public:
    /**
    ...
    /**
     * Constructs a ChassisTurretDriveCommand that will control `chassis`.
     *
...
private:
    ...
    uint32_t prevTime = 0;
};  // class ChassisTurretDriveCommand
