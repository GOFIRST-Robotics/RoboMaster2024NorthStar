...
#include "control/governor/command_governor_interface.hpp"
...
private:
    ...
    bool enoughHeatToLaunchProjectile() const
    {
        ...
        //uses the heat limit for 17mm barrels which I think is just the standard
        uint16_t heat = 0, heatLimit = robotData.turret.heatLimit17ID1;
